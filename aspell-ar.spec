...
Summary(pl):	S³ownik arabski dla aspella
Name:		aspell-ar
Version:	1.2
%define	subv	0
Release:	1
...
Source0:	ftp://ftp.gnu.org/gnu/aspell/dict/ar/aspell6-ar-%{version}-%{subv}.tar.bz2
...
%description -l pl
S³ownik arabski (lista s³ów) dla aspella.
